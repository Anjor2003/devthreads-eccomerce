...
const Products: React.FC<{ allProducts: ProductType[] }> = ({
  allProducts,
}) => {
        ...
        <div className="md:flex justify-between items-center mb-6">
          ...
          <div className="md:flex items-center">
            ...
            <select
              ...
              className="md:w-48 w-full md:mt-0 mt-1 py-2 px-3 h-10 bg-transparent rounded outline-none border border-gray-100 focus:ring-0"
            >
